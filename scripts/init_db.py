...
async def init():
    ...
    try:
        ...
        target_conn = await asyncpg.connect(user=user, password=password, host=host, port=port, database=target_db)
        try:
        ...
        try:
            ...
            print(f'[!] pgvector is not installed in PostgreSQL 16 on this machine.')
